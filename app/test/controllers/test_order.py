...
def __create_sizes_ingredients_beverages(
...
def test_create(app, ingredients, size, client_data, beverages):
    (
        ...
        created_ingredients,
        created_beverages,
    ) = __create_sizes_ingredients_beverages(ingredients, [size], beverages)
    order = __order(
        created_ingredients, created_size, client_data, created_beverages
    )
...
def test_get_all(app, ingredients, sizes, client_data, beverages):
    (
        ...
        created_ingredients,
        created_beverages,
    ) = __create_sizes_ingredients_beverages(ingredients, sizes, beverages)
    created_orders = []
    for _ in range(5):
        order = __order(
