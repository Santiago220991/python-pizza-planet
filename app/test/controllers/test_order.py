...
def __create_beverages_items(items: list, controller: BaseController):
    created_items = []
...
def __create_sizes_ingredients_beverages(ingredients: list, sizes: list, beverages: list):
    created_ingredients = __create_items(ingredients, IngredientController)
    created_sizes = __create_items(sizes, SizeController)
    created_beverages = __create_beverages_items(beverages, BeverageController)
...
def test_create(app, ingredients, size, client_data, beverages):
    created_size, created_ingredients, created_beverages = __create_sizes_ingredients_beverages(ingredients, [size], beverages)
...
def test_get_all(app, ingredients, sizes, client_data, beverages):
    created_sizes, created_ingredients, created_beverages = __create_sizes_ingredients_beverages(ingredients, sizes, beverages)
    created_orders = []
    for _ in range(5):
