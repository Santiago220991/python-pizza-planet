...
def test_create_order_service_with_invalid_size(create_order_with_invalid_size):
    order = create_order_with_invalid_size.json
    pytest.assume(order == "Invalid size")


def test_create_order_service_with_invalid_data(create_order_with_invalid_client_data):
