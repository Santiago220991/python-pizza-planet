...
class ReportController:
    ...
    def get_most_requested_ingredient():
        ...
        ingredient_name = IngredientController.get_by_id(
            most_requested_ingredient[0]
        )[0]["name"]
    ...
    def get_best_costumers():
        best_clients = (
            Order.query.with_entities(
                Order.client_name, func.sum(Order.total_price)
            )
    ...
    def create(cls):
        try:
            return {
                ...
                cls.get_most_requested_ingredient(),
                "month_with_the_higest_revenue":
                cls.get_month_with_most_revenue(),
